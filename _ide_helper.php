...
namespace  {
             ...
             * 
             *
             * @see \App\Lib\Searchable::searchable()
             * @param mixed $params
             * @param mixed $like
             * @static 
             */            public static function searchable($params, $like = true)
            {
                                return \Illuminate\Database\Eloquent\Builder::searchable($params, $like);
            }
                            /**
             * 
             *
             * @see \App\Lib\Searchable::filter()
             * @param mixed $params
             * @static 
             */            public static function filter($params)
            {
                                return \Illuminate\Database\Eloquent\Builder::filter($params);
            }
                            /**
             * 
             *
             * @see \App\Lib\Searchable::dateFilter()
             * @param mixed $column
             * @static 
             */            public static function dateFilter($column = 'created_at')
            {
                                return \Illuminate\Database\Eloquent\Builder::dateFilter($column);
            }
                            /**
            ...
            class Status extends \App\Constants\Status {}
